...
define DO_CXX
$(echo_cmd) "CXX $<"
$(Q)$(CXX) -std=c++11 $(CXXFLAGS) $(NOTSHLIBCFLAGS) $(CFLAGS) $(CLIENT_CFLAGS) $(OPTIMIZE) -o $@ -c $<
endef
...
define DO_DED_CXX
$(echo_cmd) "DED_CXX $<"
$(Q)$(CXX) -std=c++11 $(CXXFLAGS) $(NOTSHLIBCFLAGS) -DDEDICATED $(CFLAGS) $(SERVER_CFLAGS) $(OPTIMIZE) -o $@ -c $<
endef
