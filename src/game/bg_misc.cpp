...
===============
*/
void BG_PositionBuildableRelativeToPlayer(const playerState_t *ps, vec3_t mins, vec3_t maxs,
    traceFunc_t trace, vec3_t outOrigin, vec3_t outAngles, trace_t *tr)
{
...
void BG_InitAllowedGameElements(void)
{
    ...
    Cvar_VariableStringBuffer("g_disabledEquipment", cvar, MAX_CVAR_VALUE_STRING);

    BG_ParseCSVEquipmentList(
        cvar, bg_disabledGameElements.weapons, WP_NUM_WEAPONS, bg_disabledGameElements.upgrades, UP_NUM_UPGRADES);

    Cvar_VariableStringBuffer("g_disabledClasses", cvar, MAX_CVAR_VALUE_STRING);

    BG_ParseCSVClassList(cvar, bg_disabledGameElements.classes, PCL_NUM_CLASSES);

    Cvar_VariableStringBuffer("g_disabledBuildables", cvar, MAX_CVAR_VALUE_STRING);
...
int BG_LoadEmoticons(emoticon_t *emoticons, int num)
{
    ...
    numFiles = FS_GetFileList("emoticons", "x1.tga", fileList, sizeof(fileList));
