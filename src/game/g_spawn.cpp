...
void G_ParseField(const char *key, const char *value, gentity_t *ent)
{
    ...
    f = static_cast<spawnField_t *>(bsearch(key, fields, ARRAY_LEN(fields), sizeof(spawnField_t), cmdcmp));
    if (!f)
        return;
    b = (byte *)ent;
...
void SP_worldspawn(void)
{
    ...
    SV_SetConfigstring(CS_WARMUP, "-1");
