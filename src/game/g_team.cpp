...
void G_UpdateTeamConfigStrings(void)
{
    ...
    SV_SetConfigstringRestrictions(CS_VOTE_YES + TEAM_ALIENS, &humanTeam);
    SV_SetConfigstringRestrictions(CS_VOTE_NO + TEAM_ALIENS, &humanTeam);
    ...
    SV_SetConfigstringRestrictions(CS_VOTE_YES + TEAM_HUMANS, &alienTeam);
    SV_SetConfigstringRestrictions(CS_VOTE_NO + TEAM_HUMANS, &alienTeam);
