...
static void CG_DrawBoxFace(vec3_t a, vec3_t b, vec3_t c, vec3_t d)
{
    ...
    re->AddPolyToScene(cgs.media.outlineShader, 4, verts, 1);
}
...
static void CG_Missile(centity_t *cent)
{
    ...
    {
        re->AddLightToScene(cent->lerpOrigin, wim->missileDlight, wim->missileDlightColor[0],
    ...
    if (wim->missileSound)
    {
        ...
        S_AddLoopingSound(cent->currentState.number, cent->lerpOrigin, velocity, wim->missileSound);
    }
