...
void CG_TestModel_f(void)
{
    ...
    cg.testModelEntity.hModel = re->RegisterModel(cg.testModelName);
    ...
    cg.testModelBarrelEntity.hModel = re->RegisterModel(cg.testModelBarrelName);
...
static void CG_DrawSurfNormal(void)
{
    ...
    re->AddPolyToScene(cgs.media.outlineShader, 4, normal, 1);
}
